                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description_id" id="description_id" class="form-control @error('description_id') is-invalid @enderror" rows="5" placeholder="Enter indonesia product description">{{ old('description_id') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description_en" id="description_en" class="form-control @error('description_en') is-invalid @enderror" rows="5" placeholder="Enter english product description">{{ old('description_en') }}</textarea>
