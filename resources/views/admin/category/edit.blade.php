...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Edit Category Product</h4>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('category-product.update', $categoryProduct) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" id="name_id" name="name_id" value="{{ old('name_id', $categoryProduct->name_id) }}"
                            ...
                            <div class="mb-3">
                                <label for="name_en" class="form-label">Indonesia Category Name</label>
                                <input type="text" id="name_en" name="name_en" value="{{ old('name_en', $categoryProduct->name_en) }}"
                                class="form-control @error('name_en') is-invalid @enderror" placeholder="Enter indonesia category name">
                                @error('name_en')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
