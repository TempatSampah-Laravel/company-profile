@if(user_akses2('category', Auth::user()->role_id)->view ?? 0 =='1')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Category Product</h4>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-between">
                    <div class="col-auto">
                        <h4>Table Category Product</h4>
                    </div>
                    <div class="col-auto">
                        <div class="text-lg-end my-1 my-lg-0">
                            @if(user_akses2('category', Auth::user()->role_id)->input ?? 0 =='1')
                            <a href="{{ route('category-product.create') }}" class="btn btn-primary"> <i class="fas fa-plus"></i><span class="mx-1">Create New Category Product</span></a>
                            @endif
                        ...
                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                <tr style="background: #f3f7f9">
                                    ...
                                    @if(user_akses2('category', Auth::user()->role_id)->update ?? 0 =='1' OR user_akses2('category', Auth::user()->role_id)->delete ?? 0 =='1')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        action="{{ route('category-product.destroy', $category) }}"
                                        method="POST">

                                        @if(user_akses2('category', Auth::user()->role_id)->update ?? 0 =='1')
                                        <a href="{{ route('category-product.edit', $category) }}" title="Edit" class="btn btn-info btn-sm">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        @endif

                                        @if(user_akses2('category', Auth::user()->role_id)->delete ?? 0 =='1')
