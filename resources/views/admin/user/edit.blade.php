                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="">
                                    <span class="badge bg-blue mb-2">If you don't want to change your password, you don't need to enter it!</span>
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('role_id') is-invalid @enderror" name="role_id" id="role_id" data-toggle="select2" data-width="100%">
                                    ...
                                    <option value={{ $item->id }} selected='selected'> {{ $item->name_role }} </option>
                                    @else
                           ...
                           <div class="col-5">
                                ...
                                <input type="file" data-plugins="dropify" data-max-file-size="2M" name="avatar" class="form-control @error('avatar') is-invalid @enderror" accept="image/*" data-default-file="{{ asset('upload/user/'. $user->avatar) }}" />
                                @error('avatar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
