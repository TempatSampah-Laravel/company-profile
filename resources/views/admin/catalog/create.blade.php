        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Create Catalog</li>
                </ol>
            </div>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-auto">
                        <div class="text-lg-end my-1 my-lg-0">
                            <a href="{{ route('catalog.index') }}" class="btn btn-success"> <i class="fe-arrow-left"></i><span class="mx-1">Back</span></a>
                        </div>
                    </div><!-- end col-->
                </div> <!-- end row -->
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="mb-3">
                                ...
                                class="form-control @error('name_id') is-invalid @enderror" placeholder="Enter indonesia catalog name">
                                @error('name_id')
                            ...
                            <div class="mb-3">
                                ...
                                class="form-control @error('name_en') is-invalid @enderror" placeholder="Enter english catalog name">
                                @error('name_en')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="description_id" name="description_id"
                                    ...
                                    rows="5" placeholder="Enter indonesia catalog description">{{ old('description_id',$config->description_id) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="description_en" name="description_en"
                                    ...
                                    rows="5" placeholder="Enter english catalog description">{{ old('description_en',$config->description_en) }}</textarea>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="imgInp" name="pdf" class="form-control mt-2 @error('pdf') is-invalid @enderror" accept="application/pdf" data-default-file="" />
                                    @error('pdf')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
