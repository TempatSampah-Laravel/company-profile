        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-between">
                    <div class="col-auto">
                        <h4>Table Role Access</h4>
                    </div>
                    <div class="col-auto">
                        <div class="text-lg-end my-1 my-lg-0">

                            @if(user_akses2('role', Auth::user()->role_id)->input ?? 0 =='1')
                            <a href="{{ route('role.create') }}" class="btn btn-primary"> <i class="fas fa-plus"></i><span class="mx-1">Create New User</span></a>
                            @endif
                        ...
                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                <tr style="background: #f3f7f9">
                                    ...
                                    @if(user_akses2('role', Auth::user()->role_id)->posting ?? 0 =='1' OR user_akses2('role', Auth::user()->role_id)->update ?? 0 =='1' OR user_akses2('role', Auth::user()->role_id)->delete ?? 0 =='1')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('role.access', $role) }}" title="Access" class="btn btn-success btn-sm">
                                            <i class="far fa-eye"></i>
                                        </a>
                                        @endif

                                        @if(user_akses2('role', Auth::user()->role_id)->update ?? 0 =='1')
                                        <a href="{{ route('role.edit', $role) }}" title="Access" class="btn btn-info btn-sm">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        @endif
                                        
                                        @if(user_akses2('role', Auth::user()->role_id)->delete ?? 0 =='1')
