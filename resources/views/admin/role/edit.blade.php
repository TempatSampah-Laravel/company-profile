        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Edit Role Acccess</li>
                </ol>
            </div>
            <h4 class="page-title">Edit Role Access</h4>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('role.update', $role) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="name_role" name="name_role" value="{{ $role->name_role }}"
