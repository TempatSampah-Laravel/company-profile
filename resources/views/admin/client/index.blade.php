@if(user_akses2('client', Auth::user()->role_id)->view ?? 0 =='1')
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-auto">
                        <div class="text-lg-end my-1 my-lg-0">
                            ...
                            <a href="{{ route('client.create') }}" class="btn btn-primary"> <i class="fas fa-plus"></i><span class="mx-1">Create New Client</span></a>
                            @endif
                        ...
                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                <tr style="background: #f3f7f9">
                                    ...
                                    @if(user_akses2('client', Auth::user()->role_id)->update ?? 0 =='1' OR user_akses2('client', Auth::user()->role_id)->delete ?? 0 =='1')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="{{ asset('upload/client/'. $client->image) }}" class="rounded" width="50px" height="50px" alt="image">
                                    </td>
                                    <td>{{ $client->name }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('client.edit', $client) }}" title="Edit" class="btn btn-info btn-sm">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        @endif

                                        @if(user_akses2('client', Auth::user()->role_id)->delete ?? 0 =='1')
