!(function (p, d, u) {
    ...
    function t() {
        ...
        h || (i && n && !joinchat_obj.settings.message_badge && s) || (l += " joinchat--tooltip"),
            ...
            joinchat_obj.is_mobile &&
                (p(u).on("focus blur", "input, textarea", function (t) {
    ...
    (d.joinchat_obj = d.joinchat_obj || {}),
        (joinchat_obj = p.extend({ $div: null, settings: null, store: null, chatbox: !1, showed_at: 0, is_mobile: !1 }, joinchat_obj)),
            ...
            "function" == typeof t &&
                ...
                "function" == typeof gtag &&
                    ...
                    n.forEach(function (t) {
                        "config" == t[0] && "G-" == t[1].substring(0, 2) && gtag("event", e, { event_category: "JoinChat", event_label: o, send_to: t[1], transport_type: "beacon" });
                    }),
                "object" == typeof n && n.push({ event: "JoinChat", eventAction: e, eventLabel: o }),
        ...
        (joinchat_obj.open_whatsapp = function (t, o) {
            ...
            p(u).trigger("joinchat:open", [t, this.settings]),
                o.test(t.link) ? (this.send_event(t.link), d.open(t.link, "joinchat", "noopener")) : console.error("Join.chat: the link doesn't seem safe, it must point to the current domain or whatsapp.com");
        });
    var o,
        e =
            ((o = function () {
